                ...
                <CTableRow v-for="m in filteredMembers" :key="m.id">
                  <CTableDataCell>
                    <div class="d-flex align-items-center">
                      <CAvatar
                        :color="m.status === 'active' ? 'primary' : 'secondary'"
                        text-color="white"
                        size="sm"
                        class="me-2"
                      >
                  ...
                  <CTableDataCell>
                    <CBadge :color="m.status === 'active' ? 'success' : 'secondary'">{{
                      m.status
                    }}</CBadge>
                  </CTableDataCell>
                  <CTableDataCell class="text-end">
                    ...
                    <CDropdown variant="btn-group">
                      ...
                      <CDropdownMenu>
                        ...
                        <CDropdownDivider />
                        <CDropdownItem class="text-danger" @click="removeMember(m)"
                          >Remove</CDropdownItem
                        >
                      </CDropdownMenu>
                    </CDropdown>
                  </CTableDataCell>
            ...
            <CListGroup flush>
              ...
              >
                <div
                  ...
                  :class="'bg-' + a.color + '-subtle text-' + a.color"
                >
                  <i :class="a.icon"></i>
                </div>
                <div>
    ...
    <Teleport to="body">
      <CModal :visible="showMemberModal" @close="showMemberModal = false">
        ...
        <CModalFooter>
          ...
          <CButton color="primary" @click="saveMember">
...
const recentActivity = ref([
  {
    id: 1,
    description: 'Ama Mensah attended Sunday service',
  ...
  {
    id: 2,
    description: 'Yaa Osei marked inactive',
    icon: 'bi bi-person-x',
    color: 'warning',
    time: 'Yesterday',
  },
...
function changeMemberStatus(m) {
  ...
  toast.success(`${m.name} marked as ${m.status}`);
}
...
function sendMessage() {
  ...
  toast.success(`Message sent to ${activeCount.value} members`);
}
...
function scheduleMeeting() {
  ...
  toast.success('Meeting scheduled and reminders sent');
}

function downloadReport() {
  toast.info('Member list export started');
}
</script>
