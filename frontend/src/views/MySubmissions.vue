          ...
          <CTable hover responsive align="middle">
            ...
            <CTableBody>
              <CTableRow v-for="a in filteredAttendance" :key="a.id">
                ...
                <CTableDataCell class="text-center fw-bold">{{
                  a.adults + a.children + a.visitors
                }}</CTableDataCell>
                <CTableDataCell>
          ...
          <CTable hover responsive align="middle">
            ...
            <CTableBody>
              <CTableRow v-for="v in filteredVisitors" :key="v.id">
                ...
                <CTableDataCell>
                  <CBadge :color="followUpStatusColor(v.followUpStatus)">{{
                    v.followUpStatus
                  }}</CBadge>
                </CTableDataCell>
              </CTableRow>
...
const attendanceSubmissions = ref([
  ...
  },
  {
    ...
    visitors: 2,
    status: 'approved',
    submittedAt: '2026-01-22T19:45:00',
    notes: '',
  },
  {
    id: 3,
    date: '2026-01-19',
    serviceType: 'Sunday Second Service',
    adults: 95,
    children: 28,
    visitors: 5,
    status: 'approved',
    submittedAt: '2026-01-19T13:15:00',
    notes: '',
  },
  {
    id: 4,
    ...
    visitors: 10,
    status: 'rejected',
    rejectReason: "Numbers don't match physical count",
    submittedAt: '2026-01-12T10:30:00',
    notes: '',
  },
]);
...
const filteredVisitors = computed(() => {
  ...
  return visitorSubmissions.value.filter(
    v => v.name.toLowerCase().includes(s) || v.phone.includes(s)
  );
});
...
function saveAttendance() {
  if (editingId.value) {
    ...
    if (idx !== -1) {
      attendanceSubmissions.value[idx] = {
        ...attendanceSubmissions.value[idx],
        ...attendanceForm,
        status: 'pending',
      };
    }
    toast.success('Attendance updated and resubmitted');
  } else {
